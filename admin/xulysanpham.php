...
<?php
	if(isset($_POST['themsanpham'])){
		...
		$sql_insert_product = mysqli_query($con,"INSERT INTO tbl_sanpham(sanpham_name,sanpham_mota,sanpham_gia,sanpham_image,category_id) values ('$tensanpham','$mota','$gia','$hinhanh','$danhmuc')");
		...
		$path = '../uploads/';
		if($hinhanh==''){
			$sql_update_image = "UPDATE tbl_sanpham SET sanpham_name='$tensanpham',sanpham_mota='$mota',sanpham_gia='$gia',category_id='$danhmuc' WHERE sanpham_id='$id_update'";
		}else{
			move_uploaded_file($hinhanh_tmp,$path.$hinhanh);
			$sql_update_image = "UPDATE tbl_sanpham SET sanpham_name='$tensanpham',sanpham_mota='$mota',sanpham_gia='$gia',sanpham_image='$hinhanh',category_id='$danhmuc' WHERE sanpham_id='$id_update'";
		}
